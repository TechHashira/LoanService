...
exports.MigBeta1615362562404 = void 0;
class MigBeta1615362562404 {
    constructor() {
        this.name = 'MigBeta1615362562404';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query("CREATE TABLE `user_saving` (`id` int NOT NULL AUTO_INCREMENT, `dividendsEarned` int NOT NULL DEFAULT '0', `monthlySavingRate` int NOT NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `admin` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(255) NOT NULL, `role` enum ('ADMIN_ROLE', 'USER_A_ROLE', 'USER_B_ROLE') NOT NULL DEFAULT 'ADMIN_ROLE', `password` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
...
exports.MigBeta1615362562404 = MigBeta1615362562404;
//# sourceMappingURL=1615362562404-MigBeta.js.map